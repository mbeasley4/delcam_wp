...
/**
 * Register all ACF Gutenberg blocks for the DelCam theme.
 */
function my_register_acf_blocks() {
	$block_listing = array(
		...
		array(
			...
			'title'           => 'DelCam: Portfolio Marquee',
			'render_template' => 'template-parts/blocks/portfolio-marquee.php',
			'category'        => 'delcam',
			'keywords'        => array( 'delcam', 'block', 'acf', 'marquee', 'ticker' ),
		),
		array(
			'name'            => 'investment-strategy',
			'title'           => 'DelCam: Investment Strategy',
			'render_template' => 'template-parts/blocks/investment-strategy.php',
			'category'        => 'delcam',
			'keywords'        => array( 'delcam', 'block', 'acf', 'strategy', 'cards' ),
		),
		array(
			'name'            => 'sectors',
			'title'           => 'DelCam: Sectors',
			'render_template' => 'template-parts/blocks/sectors.php',
			'category'        => 'delcam',
			'keywords'        => array( 'delcam', 'block', 'acf', 'sectors', 'pills' ),
		),
		array(
			'name'            => 'funds-overview',
			'title'           => 'DelCam: Funds Overview',
			'render_template' => 'template-parts/blocks/funds-overview.php',
			'category'        => 'delcam',
			'keywords'        => array( 'delcam', 'block', 'acf', 'funds', 'portfolio' ),
		),
	);
